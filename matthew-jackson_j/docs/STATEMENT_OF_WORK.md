...
- Reference: https://support.edifabric.com/hc/en-us/articles/360000361352-How-to-validate-HIPAA-SNIP-levels
...
3. Use basic 837 sample file for testing (source: EdiFabric free trial and C# samples page)
   ```
   https://support.edifabric.com/hc/en-us/articles/360000280532-Free-code-to-master-you-EDI-files
   ```
...
- [x] Application successfully parses 837 EDI file
- [x] Data is correctly stored in SQL Server Express
